...
export interface DashboardViewModel { state: 'loading' | 'empty' | 'error' | 'forbidden' | 'success'; metrics: DashboardMetrics | null; recentShipments: HomeShipmentSummary[]; cards: DashboardMetricCard[]; operationDistribution: DashboardDistributionItem[]; modeDistribution: DashboardDistributionItem[]; message?: string; }
